...
Event Bubbling হলো DOM-এর ইভেন্ট হ্যান্ডলিং পদ্ধতি যেখানে ইভেন্ট child → parent পর্যন্ত উপরে উঠে যায়।
...
Parent element-এ ইভেন্ট হ্যান্ডলার বসিয়ে child element-এর ইভেন্ট handle করা।
...
বড় list বা dynamic elements-এর জন্য খুব efficient।



---

5. Difference Between preventDefault() & stopPropagation()
